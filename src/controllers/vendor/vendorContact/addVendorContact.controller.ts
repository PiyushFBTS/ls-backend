...
export const addVendorContact = async (req: Request, res: Response) => {
    try {
        ...
        const { cmp_code, cmp_name, contact_code, job_title, name, search_name, address, address_2,
            county, state, city, post_code, phone_no, mobile_phone_no, email, image, } = body;
    ...
    `;
        ...
        const values = [
            cmp_code, cmp_name, contact_code, job_title, name, search_name, address, address_2, county,
            state, city, post_code, phone_no, mobile_phone_no, email, last_date_modified,
            last_time_modified, imageBuffer,
        ];
